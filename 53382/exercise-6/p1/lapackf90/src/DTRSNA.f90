...
!
      ...
      if ( .NOT.WANTS .AND. .NOT.WANTSP ) then
         ...
         INFO = -6
      else if ( LDVL < 1 .OR. ( WANTS .AND. LDVL.LT.N ) ) then
         INFO = -8
      else if ( LDVR < 1 .OR. ( WANTS .AND. LDVR.LT.N ) ) then
         INFO = -10
      ELSE
!
...
!
         if ( MM < M ) then
            INFO = -13
         else if ( LDWORK < 1 .OR. ( WANTSP .AND. LDWORK.LT.N ) ) then
            INFO = -16
         end if
      end if
      if ( INFO.NE.0 ) then
