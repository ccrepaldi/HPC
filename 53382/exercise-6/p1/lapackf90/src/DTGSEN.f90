...
!
      ...
      WANTD1 = IJOB == 2 .OR. IJOB.EQ.4
      WANTD2 = IJOB == 3 .OR. IJOB.EQ.5
...
!
   ...
   10 CONTINUE
!
      if ( IJOB == 1 .OR. IJOB.EQ.2 .OR. IJOB.EQ.4 ) then
         LWMIN = MAX( 1, 4*N+16, 2*M*( N-M ) )
         LIWMIN = MAX( 1, N+6 )
      else if ( IJOB == 3 .OR. IJOB.EQ.5 ) then
